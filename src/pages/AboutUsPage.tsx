    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow bg-white">
        <div className="container-custom py-12">
          <h1 className="text-3xl md:text-4xl font-bold text-[#19747E] mb-8">About Artyssn</h1>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div>
              <h2 className="text-2xl font-semibold text-[#19747E] mb-4">Our Story</h2>
              <p className="text-gray-600 mb-4">
                Artyssn was founded in 2023 with a simple mission: to connect talented local artisans with people who appreciate handcrafted quality and unique items. What started as a small community marketplace has grown into a platform that celebrates craftsmanship and supports the creative economy.
              </p>
              <p className="text-gray-600 mb-4">
                Our founder, Emma Rogers, noticed that many talented artisans in her community had limited options to showcase and sell their work. Believing in the value of handmade items and the stories behind them, she created Artyssn as a bridge between makers and buyers who share an appreciation for craftsmanship.
              </p>
            </div>
          ...
          <div className="mb-12">
            ...
            <p className="text-gray-600 mb-4">
              Whether you're a skilled artisan looking to share your creations or a discerning buyer seeking unique handcrafted items, we welcome you to the Artyssn community. Together, we can support local craftsmanship and bring more beauty and meaning into our everyday lives.
            </p>
