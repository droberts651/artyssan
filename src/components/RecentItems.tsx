              ...
              <div className="relative h-64 overflow-hidden group">
                ...
                <div className="absolute inset-0 bg-black bg-opacity-20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                  <div className="flex gap-3">
                    ...
                    <Button size="icon" variant="secondary" className="rounded-full bg-craft-terracotta text-white hover:bg-craft-terracotta/90" onClick={() => handleAddToCart(item)}>
                      <ShoppingCart size={18} />
                    </Button>
                  </div>
                </div>
                <div className="absolute top-2 right-2 text-white text-xs px-2 py-1 rounded bg-cyan-700">
                  {item.category}
                </div>
              </div>
              <div className="p-5">
                ...
                <div className="mt-3 flex justify-between items-center">
                  ...
                  <Button variant="ghost" size="sm" className="text-craft-navy hover:text-craft-terracotta" asChild>
